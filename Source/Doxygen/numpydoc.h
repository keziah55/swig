...
#ifndef SWIG_NUMPYDOC_H
#define SWIG_NUMPYDOC_H
...
class NumPyDocConverter : public DoxygenTranslator {
public:
...
protected:
   ...
   */
  typedef void (NumPyDocConverter::*tagHandler)(DoxygenEntity &tag, std::string &translatedComment, const std::string &arg);
